...
class RentalItem:
	...
	def	editinfo(self, type, condition, price_per_day):
		self.type = type
		self.condition = condition
		self.price_per_day = price_per_day
...
class Car(RentalItem):
	...
	def	editinfo(self, type, brand, model, year, condition, price_per_day):
		super().editinfo(type, condition, price_per_day)
		self.brand = brand
		self.model = model
		self.year = year
